...
public class TablePage extends BasePage {
	    ...
	    public void randomValueINCol() throws InterruptedException {
			Thread.sleep(3000);                                       
			 List<WebElement> columnElements = driver.findElements(By.xpath("//table[@id='table1']/tbody/tr/td[1]"));
		        Random random = new Random();
		        int randomIndex = random.nextInt(columnElements.size());
		        WebElement randomElement = columnElements.get(randomIndex);
